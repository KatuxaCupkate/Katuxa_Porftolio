...
## Editing links
All preview/contact URLs live in one place: **`js/config.js`**.
Paste your links between the quotes — empty values show a disabled "Link soon"
button so the page never ships a dead link.
